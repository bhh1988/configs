...
<bindings id="htmlBindings"
  ...
  <binding id="inputFields">
    ...
    <!-- Cut/copy/paste/undo -->
    <handler event="keypress" key="c" modifiers="accel,shift" command="cmd_copy"/>
    <handler event="keypress" key="x" modifiers="accel,shift" command="cmd_cut"/>
  ...
  <binding id="browser">
    <handlers>
      ...
      <handler event="keypress" key="x" command="cmd_cut" modifiers="accel,shift"/>
      <handler event="keypress" key="c" command="cmd_copy" modifiers="accel,shift"/>
